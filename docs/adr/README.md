...
| 共享 UI、Desktop 设置界面或 Web Console 原语 | [0017](0017-shared-vue-ui-package.md) | `@godgesture/ui` 只提供无业务 Vue 原语与 token；`packages/shared` 继续无 Vue，Desktop 不再依赖 Element Plus，Console 仍由 Server 拥有 |
