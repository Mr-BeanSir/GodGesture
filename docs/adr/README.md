...
| 仓库结构、共享协议或技术栈 | [0002](0002-pnpm-monorepo.md), [0003](0003-initial-tech-stack.md), [0015](0015-private-server-and-web-console-submodules.md) | pnpm 根工作区，私有 Server/Web Console 子模块，Tauri/Vue/NestJS/Prisma/REST + OpenAPI |
...
| 后端职责、更新、模板或插件分发 | [0008](0008-backend-owns-only-user-data.md) | Server 只存用户数据,模板和在线插件目录等公开内容通过 GitHub 分发 |
...
- `0001`~`0004`、`0006`、`0008`~`0012`、`0015`:有效；`0015` 取代 `0002` 中直接追踪 Server/Web Console 目录的部分。
