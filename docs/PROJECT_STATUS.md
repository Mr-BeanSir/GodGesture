...
最后核对:2026-07-29。产品代码与发布配置基线覆盖至 `50771fe`;此后的状态文档提交不改变产品行为。接手时仍须执行 `git status --porcelain=v1` 和 `git log --oneline -12`,不要假定 HEAD 或工作区状态。
