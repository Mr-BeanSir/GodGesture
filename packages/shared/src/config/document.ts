 ...
 */
import { z } from "zod";
import { AppEntry, GlobalApp, HotCornersConfig, RubEdgesConfig } from "./gestures.js";
...
export const ConfigDocument = z.object({
  formatVersion: z.literal(CONFIG_FORMAT_VERSION).default(CONFIG_FORMAT_VERSION),
  global: GlobalApp.default({}),
  apps: z.array(AppEntry).default([]),
